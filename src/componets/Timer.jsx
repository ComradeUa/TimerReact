...
import './Timer.scss';
const Timer = ({hours, minutes,seconds,setHours,setMinutes,setSeconds, isBlackTheme}) => {
    ...
    return (
        <div className="flex justify-center mt-40">
            <div className="cont-container rounded bg-[#F9F9F9] w-90 h-80">
                ...
                <div className="flex flex-row items-start justify-center m-10 mx-40 space-x-10">
                    <button className='button_style_start' onClick={handleStart}>START</button>
                    <button className='button_style_pause' onClick={handleStop}>PAUSE</button>
                    <button className='button_style_reset' onClick={handleReset}>RESET</button>
                </div>
